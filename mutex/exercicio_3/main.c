...
int main(int argc, char** argv) {
    ...
    //Iniciaiza atributo do mutex
    pthread_mutexattr_init(&gMtx_attr);
    pthread_mutexattr_settype(&gMtx_attr, PTHREAD_MUTEX_RECURSIVE);
    //Inicializa o mutex
    pthread_mutex_init(&gMtx, &gMtx_attr);
    ...
    pthread_mutexattr_destroy(&gMtx_attr);
